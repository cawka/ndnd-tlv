...
#ifndef NDN_BLOOM_DEFINED
#define NDN_BLOOM_DEFINED
 ...
 * number of members.
 */
struct ndn_bloom *ndn_bloom_create(int estimated_members,
...
/*
 * ndn_bloom_validate_wire: Check for a valid on-wire representation
...
/*
 * ndn_bloom_match_wire: Test membership using on-wire representation
 * Caller is expected to have validated f.
 * Returns true to indicate a match.
 */
int ndn_bloom_match_wire(const struct ndn_bloom_wire *f,
